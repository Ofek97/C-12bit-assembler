...
enum preprocess_line_detection preproc_check_line(char* line, struct macro** macro, const Vector macro_table,const Trie macro_lookup){
...
const char* preproc(const char* file_name){
    ...
    while(fgets(line_buff,sizeof(line_buff),as_file)){
        switch(preproc_check_line(line_buff,&find_macro,macro_table_lookup,macro_table)){
